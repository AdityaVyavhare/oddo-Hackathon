...
const Budget = () => {
  ...
  const activityCosts =
    trip.cities?.reduce((total, cityStop) => {
      const cityActivityCosts = (cityStop.activities || []).reduce(
        (sum, activityId) => {
  ...
  const totalCalculated =
    budget.transport + budget.stay + budget.food + activityCosts;
  const days =
    Math.ceil(
      ...
      <div className={styles.container}>
        <Reveal animation="fade">
          <div className={styles.header}>
            ...
            <Link to={`/trip/${tripId}/view`} className={styles.backButton}>
              <ArrowLeft size={18} />
        ...
        <Reveal animation="up" delay={0.1}>
          <div className={styles.statsGrid}>
            ...
            <div className={styles.statCard}>
              ...
              <p
                className={`${styles.statValue} ${
                  budget.total - totalCalculated < 0
                    ? styles.overBudget
                    : styles.underBudget
                }`}
              >
          ...
          <div className={styles.warning}>
            ...
            <div>
              ...
              <p className={styles.warningText}>
                Your estimated costs exceed your budget by $
                {(totalCalculated - budget.total).toLocaleString()}
              </p>
            </div>
          </div>
        )}
        ...
        <div className={styles.categoryCard}>
          ...
          <div className={styles.categoryList}>
            <div
              className={`${styles.categoryItem} ${styles.categoryTransport}`}
            >
              <div>
            ...
            <div
              className={`${styles.categoryItem} ${styles.categoryActivities}`}
            >
              <div>
